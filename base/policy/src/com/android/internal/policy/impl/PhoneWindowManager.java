...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    static boolean mAlwaysFullScreen = true;
...
//	    }
        ...
        initializeHdmiState();
        mAlwaysFullScreen = SystemProperties.getBoolean("persist.sys.statusbar.hide", false);
		Log.e(TAG, "mAlwaysFullScreen = " + mAlwaysFullScreen);
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        ...
        /* support the mouse mode 2013-12-03 */
            ...
            Log.e(TAG, "it's KEYCODE_MOUSE key and down = " + down);
            if(!down){
                ...
                if(mNotificationEnterKeyMouseMode == null){
                    ...
                    mNotificationEnterKeyMouseMode.setLatestEventInfo(mContext,
                            mContext.getResources().getText(com.android.internal.R.string.title_key_mouse_mode),
                ...
                if(mKeyEnterMouseMode) {
                    ...
                    try {
                        ...
                        //mWindowManager.keySetMouseDistance(30);
                        mWindowManager.keySetMouseDistance(Settings.System.getInt(mContext.getContentResolver(),
                                    Settings.System.MOUSE_ADVANCE, 30));
        ...
        if (!isDefaultDisplay) {
            ...
            if ((fl & (FLAG_LAYOUT_IN_SCREEN | FLAG_FULLSCREEN | FLAG_LAYOUT_INSET_DECOR))
                ...
                if (attrs.type == TYPE_STATUS_BAR_PANEL
                    ...
                    Log.d(TAG, "mAlwaysFullScreen = " + mAlwaysFullScreen);
