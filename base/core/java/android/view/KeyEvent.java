...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_MOUSE           = 220;

    private static final int LAST_KEYCODE           = KEYCODE_MOUSE;
    /* add by cjcheng end -------------------------------------} */
    ...
    private static void populateKeycodeSymbolicNames() {
        ...
        names.append(KEYCODE_MOUSE    , "KEYCODE_MOUSE"); // add by cjcheng support the mouse mode 2013-12-03
    };
