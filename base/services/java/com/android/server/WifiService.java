...
public class WifiService extends IWifiManager.Stub {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
			...
			/*
                         * platform do not support RTC_WAKEUP command for wake up suspended system
                         * should  use RTC_SUSPEND_WAKEUP,  RTC_SUSPEND_WAKEUP is extra add for
                         * platform, add this change due to support wifi dormancy strategies.
                         */
			if (true) {
                            mAlarmManager.set(AlarmManager.RTC_SUSPEND_WAKEUP, System.currentTimeMillis()
