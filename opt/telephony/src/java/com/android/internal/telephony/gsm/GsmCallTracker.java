...
public final class GsmCallTracker extends CallTracker {
    ...
    GsmCallTracker (GSMPhone phone) {
        ...
        Log.i(LOG_TAG, "GsmCallTracker constructor create");
        Log.i(LOG_TAG,"GsmCallTracker test");
    ...
    private void
    updatePhoneState() {
        Log.i(LOG_TAG,"enter updatePhoneState");
        ...
        Log.i(LOG_TAG,"the currentphonestate state = " + state);
